...
def SurMin ( CVNumOfIter, inArg, steps, exitStep, getVal) :
    old_points = []
    old_cCos = []
    old_stepMult = 1
    par_der = []   # deriv
    ...
    opt = Factory (None, SvF.SolverNameHigh)  # ����� ����������
    dim = len(steps)
    ...
    print(f"MAIN OPTIMIZATION LOOP HAS STARTED WITH BASE OPTIM. MODE")
